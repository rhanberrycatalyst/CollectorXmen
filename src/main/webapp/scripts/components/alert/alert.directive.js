        ...
        return {
            ...
            controller: ['$scope',
                function($scope) {
                    ...
                    var cleanHttpErrorListener = $rootScope.$on('collectorthrdApp.httpError', function (event, httpResponse) {
                        var i;
                        ...
                        switch (httpResponse.status) {
                            ...
                            case 400:
                                var errorHeader = httpResponse.headers('X-collectorthrdApp-error');
                                var entityKey = httpResponse.headers('X-collectorthrdApp-params');
                                if (errorHeader) {
